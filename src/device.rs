...
impl_extended_feature!(PhysicalDeviceAccelerationStructureFeaturesKHR, acceleration_structure descriptor_binding_acceleration_structure_update_after_bind,);
