// https://github.com/jedjoud10/cflake-engine/blob/main/crates/math/src/octree/octree.rs
...
impl Octree {
    ...
    pub fn compute(&mut self, targets: &[vek::Vec3<f32>]) -> OctreeDelta {
        ...
        let new = self.nodes.iter().cloned().collect::<HashSet<_>>();
